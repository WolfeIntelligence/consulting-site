...
- IP-based equity research (section /#research): the same patent read turned on public companies. Which companies are actually building what in the AI buildout, according to their patent claims and classifications rather than press releases; who is filing where, how fast, and whether the claims cover what the market says they cover. Built classification-first (the CPC as an ontology), every count traceable to the query that produced it, every claim reading quoting the claim. Delivered as written research on a company, a technology or a space, in semiconductors, optics and photonics, imaging and power, one-off or on a schedule. Research only, not investment advice; Zachary is not a registered investment adviser. That background is also why he is careful about what AI gets right and what it makes up. He never names his employer.
