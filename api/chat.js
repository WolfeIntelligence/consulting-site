...
- Two kinds of work. First, patent search and analysis for patent and IP teams (details below); that work is remote, anywhere in the United States. Second, AI for businesses, wherever they need it: it starts with a conversation about what matters to them and what they need help with (implementing AI, building it, using it, or getting something out of the data they already have), then the pieces worth building. Based in Lakeland, Florida; business work is mostly around Polk County, over video. Assistants run on the client's own machines or in the client's own accounts, grounded in the client's own knowledge.
